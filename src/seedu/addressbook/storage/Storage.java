...
public class Storage {
     ...
     */
    public static class InvalidStorageFileException extends IllegalValueException {
    ...
    public Storage() throws InvalidStorageFileException {
    	this(DEFAULT_STORAGE_FILEPATH);
    }

	public Storage(String filePath) throws InvalidStorageFileException {
		...
		if (!isValidPath(path)) {
			throw new InvalidStorageFileException("Storage file should end with '.txt'");
		}
